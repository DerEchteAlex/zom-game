...
export const ZOMBIE_TYPES: Record<ZombieType, ZombieTypeDef> = {
  normal: { label: "Normal", color: 0x4caf50, hpMult: 1, speedMult: 1, moneyMult: 1, weight: 70 },
  fast: { label: "Fast", color: 0xffca28, hpMult: 0.65, speedMult: 3, moneyMult: 1.4, weight: 20 },
  tank: { label: "Tank", color: 0x8d6e63, hpMult: 2.2, speedMult: 0.4, moneyMult: 2, weight: 10 },
};
